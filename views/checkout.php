                                    ...
                                    <section class="panel-container-section" id="first-checkout">
                                        <form class="w85" action="" method="post">
                                            ...
                                            <div class="row-group group-checked">
                                                <div class="row">
                                                    <input class="styled-radio" id="del-r1" type="radio" checked name="nal" value="1"/>
                                                    <label class="styled-radio-label" for="del-r1">Самовывоз в Москве</label>
                                                </div>
                                                <div class="row">
                                                    <input class="styled-radio" id="del-r2" type="radio" checked name="nal" value="1"/>
                                                    <label class="styled-radio-label" for="del-r2">Курьером в Москве</label>
                                                    <p>Принимаем Visa и Vastercard</p>
                                                </div>
                                                <div class="row">
                                                    <input class="styled-radio" id="del-r3" type="radio" checked name="nal" value="1"/>
                                                    <label class="styled-radio-label" for="del-r3">Курьером за Мкад</label>
                                                    <p>Комиссия банка 4%</p>
                                                </div>
                                                <div class="row">
                                                    <input class="styled-radio" id="del-r4" type="radio" checked name="nal" value="1"/>
                                                    <label class="styled-radio-label" for="del-r4">Курьером в Санкт-Петербург</label>
                                                    <p>Комиссия банка 4%</p>
                                                </div>
                                                <div class="row">
                                                    <input class="styled-radio" id="del-r5" type="radio" checked name="nal" value="1"/>
                                            ...
                                            <div class="row-group group-checked">
                                                <div class="row">
                                                    <input class="styled-radio" id="pay-r1" type="radio" checked name="nal" value="1"/>
                                                    <label class="styled-radio-label" for="pay-r1">Наличными</label>
                                                </div>
                                                <div class="row">
                                                    <input class="styled-radio" id="pay-r2" type="radio" checked name="nal" value="1"/>
                                                    <label class="styled-radio-label" for="pay-r2">Карточкой</label>
                                                    <p>Принимаем Visa и Vastercard</p>
                                                </div>
                                                <div class="row">
                                                    <input class="styled-radio" id="pay-r3" type="radio" checked name="nal" value="1"/>
